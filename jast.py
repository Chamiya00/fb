...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Chamiya00/approval.txt/tree/main/apt.txt"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰chami")
	subprocess.check_output(["am", "start", "http://wa.me/+94789348698"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Chamiya00/approval.txt/tree/main/apt.txt').text
			if basesplit in plr:
				key = basesplit
